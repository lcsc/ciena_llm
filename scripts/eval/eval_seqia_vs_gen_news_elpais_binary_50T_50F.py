...
with open(LABELS_DROUGHT, "r", encoding="utf-8") as f:
    labels_drought = list(csv.DictReader(f))
...
plot_confusion_matrix(
    seqia_predictions_labels_drought,
    gen_predictions_labels_drought,
    title="Seqia vs Gen (Binary)",
    true_label="Seqia",
    pred_label="Gen",
    save_path=f"{RESULTS_DIR}/confusion_matrices/seqia_vs_gen_binary.png",
)
...
for impact in config["impacts"]:
    ...
    # Seqia vs Gen (Impacts)
    plot_confusion_matrix(
        seqia_predictions_labels_impacts,
        gen_predictions_labels_impacts,
        title=f"Seqia vs Gen (Impact: {impact})",
        true_label="Seqia",
        pred_label="Gen",
        save_path=f"{RESULTS_DIR}/confusion_matrices/seqia_vs_gen_impact_{impact}.png",
    )
