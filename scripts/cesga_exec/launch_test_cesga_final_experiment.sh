...
# export MODELS="gemma3:27b-it-q4_K_M" # REPEAT: SIMPLE
# export MODELS="llama3.1:8b-instruct-fp16" # REPEAT: SIMPLE
# export MODELS="llama3.1:8b-instruct-q4_K_M" # REPEAT: SIMPLE
# export MODELS="llama3.2:3b-instruct-q4_K_M" # REPEAT: SIMPLE
